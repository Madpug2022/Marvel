...
const mockCharacter = {
  ...
  urls: [
    {
      type: "detail",
      url: "http://marvel.com/characters/74/3-d_man?utm_campaign=apiRef&utm_source=d3a0f9b53255e9d3e209be844a5bc3ce",
    },
    {
      type: "wiki",
      url: "http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=d3a0f9b53255e9d3e209be844a5bc3ce",
    },
    {
      type: "comiclink",
      url: "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=d3a0f9b53255e9d3e209be844a5bc3ce",
    },
  ],
};
...
LOCAL_API.addTofavorites = mockAddToFavorites;
LOCAL_API.removeFromFavorites = mockRemoveFromFavorites;
